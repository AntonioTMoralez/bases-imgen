            ...
            <div class="section__content section__content--p35">
                <div class="header3-wrap">
                    <div class="header__logo">
                        <a href="#">
                            <img style="color:#ffffff;font-size: 25px; " alt="Tabla Usuarios" />
                        </a>
                    </div>
                      ...
                      ?>
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-right">Correo electronico</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                           <?php foreach ($ejecutar as $usuarios):?>
                                            <tr>




                                                <td> <?php echo $usuarios['id_lector']?></td>
                                                <td> <?php echo $usuarios['nombres']?></td>
                                                <td> <?php echo $usuarios['apellidos']?></td>
                                                <td class="text-right"> <?php echo $usuarios['direccion']?></td>
                                                <td class="text-right"> <?php echo $usuarios['telefono']?></td>
                                                <td class="text-right"> <?php echo $usuarios['correo_electronico']?></td>
                        ...
                        <div class="row">
                            ...
                            <a href="index.php" class="btn btn-black">Regresar a inicio</a>
                              <a href="UsuariosFor.php" class="btn btn-black">Ingresar nuevo usuario</a>
